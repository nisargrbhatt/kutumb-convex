...
const ProfileForm: FC<Props> = ({ profile }) => {
  const [isLoading, setIsLoading] = useState<boolean>(false);
  const createProfileAction = useMutation(api.profile.createMyProfile);
  const updateProfileAction = useMutation(api.profile.updateMyProfile);
